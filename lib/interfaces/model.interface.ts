...
export interface QueryInterface<Data, Key> {
  ...
  lt(value: number): QueryInterface<Data, Key>;
  le(value: number): QueryInterface<Data, Key>;
  gt(value: number): QueryInterface<Data, Key>;
  ge(value: number): QueryInterface<Data, Key>;
...
export interface ScanInterface<Data, Key> {
  ...
  lt(value: number): ScanInterface<Data, Key>;
  le(value: number): ScanInterface<Data, Key>;
  gt(value: number): ScanInterface<Data, Key>;
  ge(value: number): ScanInterface<Data, Key>;
